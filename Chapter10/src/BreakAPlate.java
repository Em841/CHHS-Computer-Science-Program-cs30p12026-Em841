...
public class BreakAPlate {
	...
	private void initialize() {
		...
		ImageIcon pb2 = new ImageIcon("../Chapter10/src/plates_two_broken.gif"); 
		ImageIcon pb3 = new ImageIcon("../Chapter10/src/plates_all_broken.gif");
		ImageIcon s = new ImageIcon("../Chapter10/src/sticker.gif");
		ImageIcon tp = new ImageIcon("../Chapter10/src/tiger_plush.gif");
