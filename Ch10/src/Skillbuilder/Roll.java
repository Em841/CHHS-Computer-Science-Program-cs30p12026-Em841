...
public class Roll {
	...
	private void initialize() {
		...
		ImageIcon d1 = new ImageIcon("../Ch10/src/Skillbuilder/die1.gif");
		ImageIcon d2 = new ImageIcon("../Ch10/src/Skillbuilder/die2.gif");
		ImageIcon d3 = new ImageIcon("../Ch10/src/Skillbuilder/die3.gif");
		ImageIcon d4 = new ImageIcon("../Ch10/src/Skillbuilder/die4.gif");
		ImageIcon d5 = new ImageIcon("../Ch10/src/Skillbuilder/die5.gif");
		ImageIcon d6 = new ImageIcon("../Ch10/src/Skillbuilder/die6.gif");
