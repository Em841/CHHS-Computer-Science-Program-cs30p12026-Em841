...
public class LocalBankGUI {
	...
	private void initialize() {
		...
		lblNewLabel.setFont(new Font("Georgia", Font.ITALIC, 12));
		...
		adepowith.setFont(new Font("Georgia", Font.PLAIN, 11));
		adepowith.setColumns(10);
		adepowith.setBounds(33, 188, 398, 27);
		panel.add(adepowith);
		
		fn = new JTextField();
		fn.setFont(new Font("Georgia", Font.PLAIN, 11));
		fn.setColumns(10);
		fn.setBounds(33, 243, 398, 27);
		panel.add(fn);
		
		ln = new JTextField();
		ln.setFont(new Font("Georgia", Font.PLAIN, 11));
		ln.setColumns(10);
		ln.setBounds(33, 281, 398, 27);
		panel.add(ln);
		
		beginbal = new JTextField();
		beginbal.setFont(new Font("Georgia", Font.PLAIN, 11));
		beginbal.setColumns(10);
		beginbal.setBounds(33, 332, 398, 27);
		panel.add(beginbal);
		
		JLabel accountnumber = new JLabel("Account ID:");
		accountnumber.setFont(new Font("Georgia", Font.ITALIC, 12));
		...
		beginningbalance.setFont(new Font("Georgia", Font.BOLD | Font.ITALIC, 12));
		...
		lblNewLabel_4.setFont(new Font("Georgia", Font.BOLD | Font.ITALIC, 18));
		lblNewLabel_4.setBounds(33, 103, 362, 36);
		...
		finalbutton.setFont(new Font("Georgia", Font.PLAIN, 11));
